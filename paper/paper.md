...
![ A. From bio.tools to TeSS: enable browsing on found tools in bio.tools and provide links that will search with the same terms on TeSS. B. From TeSS to bio.tools: enable browsing on found materials in TeSS and provide links that will search with the same terms on bio.tools.](./Figures_report/Figure3AB.png){width=90%}
